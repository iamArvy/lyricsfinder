    ...
    <footer>
        <section>
            <div class="logo">
                ...
                <router-link :to="{name:'Home'}" class="home"> <h5>LyricsFinder</h5> </router-link>
            </div>
            <div class="copyright"><span>Copyright ©2023.</span><span class="slash"> | </span><a href="https://www.iamarvy.com.ng">íɑʍÄrvy</a> </div>
